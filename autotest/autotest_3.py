...
card = WebDriverWait(driver, 10).until(
    EC.presence_of_all_elements_located((By.CLASS_NAME, 'cubre-a-menuLink'))
)
cardBtn = driver.find_element(By.CLASS_NAME, 'cubre-a-menuLink')
enabledCard = driver.find_element(By.XPATH, '/html/body/div[1]/main/article/div/div/div/div[1]/div/div/a[6]')
element = driver.find_element(By.XPATH, '/html/body/div[1]/main/article/section[6]/div/div[2]/div/div[2]')
...
driver.save_screenshot('autotest/screenshot3.png')
driver.quit()
